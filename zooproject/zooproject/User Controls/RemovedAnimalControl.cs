...
namespace zooproject.User_Controls
{
    public partial class RemovedAnimalControl : UserControl
    {
        ...
        public RemovedAnimalControl(Animal animal, AddFeedingTask animals)
        {
            ...
            lblName.Text = "Name: "+this.scheduleAnimal.Name;
            lblSPecies.Text = "Species: "+this.scheduleAnimal.Species.ToString();
            lblAge.Text = "Age: "+Calculator.ToAge(this.scheduleAnimal.DateOfBirth).ToString();
