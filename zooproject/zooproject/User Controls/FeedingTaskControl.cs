...
namespace zooproject.User_Controls
{
    public partial class FeedingTaskControl : UserControl
    {
        ...
        public FeedingTaskControl(FeedingTask feedingTask, FeedingSchedule feedingSchedule)
        {
            ...
            lblExhibit.Text = "Exhibit: " + exhibit.Name;
            lblDate.Text = "Date: " + feedingTask.FeedingDate.Date.ToString();
            lblTime.Text = "TimeSlot: " + this.feedingTask.FeedingTimeSlot;
        }

        private void btnDetails_Click(object sender, EventArgs e)
        {
            ModifyFeedingTask modifyFeedingTask = new ModifyFeedingTask(feedingTask);
            modifyFeedingTask.ShowDialog();
        }
    }
}
